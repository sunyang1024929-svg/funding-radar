const PROFILES = {
  ...
  "芯光界": {
    companySummary: "芯光界面向 AI 算力集群和高速通信场景研发硅光互连与光电融合产品。公司聚焦低功耗、高带宽、可规模化部署的光互连方案，服务数据中心、智算中心和下一代网络基础设施。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "瞬适科技": {
    companySummary: "瞬适科技（InstAdapt）聚焦具身智能与物理 AI 数据基础设施，提供真实物理世界数据采集、标注、训练与评测相关能力。公司面向机器人、自动驾驶和空间智能等场景，帮助模型更快适应动态环境。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "晰见科技": {
    companySummary: "晰见科技围绕类脑视觉芯片和物理 AI 计算架构开展研发，产品面向低功耗视觉感知、机器人和边缘智能场景。公司试图通过传感、计算和算法协同提升机器在真实环境中的视觉处理效率。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "艾联纳医药": {
    companySummary: "艾联纳医药是一家创新药研发企业，围绕小分子药物发现和疾病靶点验证推进早期管线。公司重点建设药物设计、转化研究和临床前开发能力，服务肿瘤、免疫或其他高未满足需求疾病方向。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "原力引擎": {
    companySummary: "原力引擎聚焦 AI for Engineering 和生成式仿真，面向工程研发提供仿真建模、设计探索和智能优化工具。公司希望用大模型与数值仿真结合，提升工业研发、装备设计和复杂系统工程效率。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "赛科动力": {
    companySummary: "赛科动力专注固态电池技术研发与产业化，围绕高安全、高能量密度电池材料、工艺和电芯产品推进量产。公司面向新能源汽车、低空飞行器、储能和消费电子等应用场景。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "简智机器人": {
    companySummary: "简智机器人围绕具身智能数据基础设施和机器人数据闭环构建平台能力，支持机器人模型训练、评测与部署。公司面向通用机器人、工业机器人和智能体开发场景，强调高质量数据和模型迭代效率。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "沐创集成电路": {
    companySummary: "沐创集成电路专注智能网卡、DPU 和高速互联芯片研发，面向数据中心、云计算和智算基础设施提供网络与数据处理芯片。公司产品服务高吞吐、低延迟的数据传输和计算卸载场景。",
    website: "https://www.mucse.com/",
    contact: "官网联系页：https://www.mucse.com/contact.html",
  },
  "研微半导体": {
    companySummary: "研微半导体聚焦半导体薄膜沉积设备和关键制程装备研发，服务集成电路、先进封装和泛半导体制造。公司围绕国产半导体设备替代、工艺适配和产线交付推进产业化。",
    website: "https://www.psrsemi.com/",
    contact: "官网联系页：https://www.psrsemi.com/",
  },
  "迈步机器人": {
    companySummary: "迈步机器人是一家康复机器人和外骨骼设备企业，产品覆盖下肢康复训练、步态训练和智能辅助行走等方向。公司面向医院、康复中心和家庭康复场景，结合机器人控制、传感和康复医学提升训练效率。",
    website: "https://www.milebot.com/",
    contact: "官网联系页：https://www.milebot.com/contact.html",
  },
  "屹艮科技": {
    companySummary: "屹艮科技面向电池材料研发和电池设计自动化建设 AI for Science 平台，支持材料筛选、配方设计和性能预测。公司将机器学习、实验数据和多尺度仿真结合，服务新能源电池研发效率提升。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "中数睿智": {
    companySummary: "中数睿智聚焦企业级大模型和 AI Agent 应用，推出语思等面向行业知识、办公协同和智能决策的产品体系。公司服务政府、央国企和大型组织的数字化与智能化升级场景。",
    website: "https://www.zhongshuruizhi.com/",
    contact: "官网联系页：https://www.zhongshuruizhi.com/",
  },
  "星邑空间": {
    companySummary: "星邑空间从事商业航天测运控、卫星数据服务和空间信息基础设施建设，面向卫星运营、遥感应用和低轨星座服务提供能力。公司围绕地面站网络、测控调度和空间数据应用推进商业化。",
    website: "https://www.xingyispace.com/",
    contact: "官网联系页：https://www.xingyispace.com/",
  },
  "中科第五纪": {
    companySummary: "中科第五纪专注具身智能和具身大脑技术，围绕机器人感知、决策、动作生成和世界模型构建基础能力。公司面向通用机器人、工业智能和真实世界交互场景推进产品化。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "Groq": {
  ...
  "中科国晟": {
    companySummary: "中科国晟动力科技有限公司专注轻型燃气轮机及相关动力装备的研发、制造和服务。公司围绕燃气轮机核心技术、试验验证、批量生产与全生命周期服务建设能力，面向分布式能源、工业动力和特种装备等应用场景。",
    website: "https://www.qdzkgs.com/",
    contact: "商务邮箱：scb@qdzkgs.com；官网公开电话：18678960108；官网： https://www.qdzkgs.com/",
  },
  "铬莱铂": {
    companySummary: "铬莱铂是一家金属增材制造企业，围绕 SLM 金属 3D 打印设备、打印服务和智能化工厂解决方案开展业务。公司布局金属 3D 打印装备生产基地与服务基地，服务航空航天、工业制造和复杂金属零部件的快速制造需求。",
    website: "https://www.glb3d.cn/",
    contact: "官网公开电话：13856183190；官网联系页：https://www.glb3d.cn/",
  },
  "上海斐睿科思": {
    companySummary: "上海斐睿科思聚焦生命科学领域的具身智能数据基础设施，建设数据采集与训练实验室、机器人系统和跨设备适配能力。公司希望用机器人与 Physical AI 支持生命科学实验数据生产、训练和科研流程自动化。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "弧光量子": {
    companySummary: "弧光量子专注量子计算软件与量子应用研发，推进量子计算与人工智能的融合。公司围绕分布式芯片、新型测控架构和量子软件能力开展研发，面向量子计算产业化和高性能计算应用场景。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
  "枢途科技": {
    companySummary: "枢途科技聚焦触觉技术和具身智能数据基础设施，研发 SynaTac 等触觉技术与产品，并提供人类行为数据采集和交付能力。公司面向机器人接触智能、生命科学和具身智能训练场景，建设从数据生产到机器人应用的技术链路。",
    website: "https://www.synapath.com/",
    contact: "官网已核验；未检索到公开商务邮箱或电话，可通过官网联系入口咨询。",
  },
  "奕行智能": {
    companySummary: "奕行智能专注 RISC-V 处理器、AI 算力芯片及相关软硬件系统研发。公司围绕自主指令集架构、智能计算和芯片生态建设产品能力，面向数据中心、边缘计算和行业智能化场景推进落地。",
    website: "未找到已核验官网",
    contact: "未找到公开商务联系方式",
  },
};
